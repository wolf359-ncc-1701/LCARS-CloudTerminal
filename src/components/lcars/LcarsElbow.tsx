...
export const LcarsElbow: React.FC<LcarsElbowProps> = ({
  ...
  const getPath = () => {
    ...
    switch (direction) {
      case "top-left":
        return `M 0,${h} L 0,${r} A ${r},${r} 0 0 1 ${r},0 L ${w},0 L ${w},${bh} L ${r},${bh} Q ${rw},${bh} ${rw},${r} L ${rw},${h} Z`;
      case "top-right":
        return `M 0,0 L ${w - r},0 A ${r},${r} 0 0 1 ${w},${r} L ${w},${h} L ${w - rw},${h} L ${w - rw},${r} Q ${w - rw},${bh} ${w - r},${bh} L 0,${bh} Z`;
      case "bottom-left":
        return `M ${rw},0 L ${rw},${h - r} Q ${rw},${h - bh} ${r},${h - bh} L ${w},${h - bh} L ${w},${h} L ${r},${h} A ${r},${r} 0 0 1 0,${h - r} L 0,0 Z`;
      case "bottom-right":
        return `M 0,${h - bh} L ${w - r},${h - bh} Q ${w - rw},${h - bh} ${w - rw},${h - r} L ${w - rw},0 L ${w},0 L ${w},${h - r} A ${r},${r} 0 0 1 ${w - r},${h} L 0,${h} Z`;
    }
  };
